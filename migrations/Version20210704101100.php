 ...
 */
final class Version20210704101100 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE message ADD COLUMN subject CLOB DEFAULT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TEMPORARY TABLE __temp__message AS SELECT id, date, name, to_recipients, text_content, html_content, raw_content, headers, cc_recipients, bcc_recipients, attachments, read, mail_group FROM message');
        ...
        , read BOOLEAN NOT NULL, mail_group VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO message (id, date, name, to_recipients, text_content, html_content, raw_content, headers, cc_recipients, bcc_recipients, attachments, read, mail_group) SELECT id, date, name, to_recipients, text_content, html_content, raw_content, headers, cc_recipients, bcc_recipients, attachments, read, mail_group FROM __temp__message');
